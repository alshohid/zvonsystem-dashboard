...
import type { INotificationItem, NotificationKind } from "@/src/types/notificationTypes";

const ICON_BY_KIND: Record<NotificationKind, ElementType> = {
  milestone: Star,
  follower: Users,
  playlist: Music,
  royalty: DollarSign,
          ...
          >
            ...
            <div
              className={`flex h-9 w-9 shrink-0 items-center justify-center rounded-lg ${
                isUnread ? "bg-[#101828] text-[#16A34A]" : "bg-[#F1F3F9] text-[#98A2B3]"
              }`}
            >
              <Icon size={16} />
            </div>
            ...
            <div className="min-w-0 flex-1">
              <p
                className={`text-sm ${
                  isUnread ? "font-semibold text-[#101828]" : "font-medium text-[#98A2B3]"
                }`}
              >
                {notification.title}
              </p>
